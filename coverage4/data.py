...
from coverage4.backward import iitems, string_class
from coverage4.debug import _TEST_NAME_FILE
from coverage4.files import PathAliases
from coverage4.misc import CoverageException, file_be_gone, isolate_module
