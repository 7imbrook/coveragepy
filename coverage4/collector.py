...
from coverage4.backward import litems, range     # pylint: disable=redefined-builtin
from coverage4.debug import short_stack
from coverage4.files import abs_file
from coverage4.misc import CoverageException, isolate_module
...
try:
    ...
    from coverage4.tracer import CTracer, CFileDisposition
except ImportError:
