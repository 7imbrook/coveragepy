...
from coverage4.annotate import AnnotateReporter
from coverage4.backward import string_class, iitems
from coverage4.collector import Collector
from coverage4.config import read_coverage_config
from coverage4.data import CoverageData, CoverageDataFiles
from coverage4.debug import DebugControl, write_formatted_info
from coverage4.files import TreeMatcher, FnmatchMatcher
from coverage4.files import PathAliases, find_python_files, prep_patterns
from coverage4.files import canonical_filename, set_relative_directory
from coverage4.files import ModuleMatcher, abs_file
from coverage4.html import HtmlReporter
from coverage4.misc import CoverageException, bool_or_none, join_regex
from coverage4.misc import file_be_gone, isolate_module
from coverage4.plugin import FileReporter
from coverage4.plugin_support import Plugins
from coverage4.python import PythonFileReporter, source_for_file
from coverage4.results import Analysis, Numbers
from coverage4.summary import SummaryReporter
from coverage4.xmlreport import XmlReporter

try:
    from coverage4.multiproc import patch_multiprocessing
...
class Coverage(object):
    ...
    To use::
        ...
        from coverage4 import Coverage
...
def process_startup():
    ...
    #. Create a .pth file in your Python installation containing::
        ...
        import coverage4 as coverage; coverage.process_startup()
    ...
    if hasattr(process_startup, "coverage4"):
...
def _prevent_sub_process_measurement():
    ...
    auto_created_coverage = getattr(process_startup, "coverage4", None)
