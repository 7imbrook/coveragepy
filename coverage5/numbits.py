...
from coverage5.backward import byte_to_int, bytes_to_ints, binary_bytes, zip_longest
from coverage5.misc import contract, new_contract
...
def register_sqlite_functions(connection):
    ...
    * :func:`numbits_to_nums`
    ...
    queries::
        ...
        import sqlite3
        from coverage5.numbits import register_sqlite_functions
