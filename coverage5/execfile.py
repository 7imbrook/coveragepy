...
from coverage5.backward import BUILTINS
from coverage5.backward import PYC_MAGIC_NUMBER, imp, importlib_util_find_spec
from coverage5.files import canonical_filename, python_reported_file
...
from coverage5.phystokens import compile_unicode
...
class PyRunner(object):
    ...
    def prepare(self):
        ...
        if os.path.isdir(sys.path[0]):
            ...
            # is the directory of the "coverage5" script.  If this is so, replace
