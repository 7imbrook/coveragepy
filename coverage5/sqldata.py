...
from coverage5.backward import get_thread_id, iitems, to_bytes, to_string
from coverage5.debug import NoDebugging, SimpleReprMixin, clipped_repr
from coverage5.files import PathAliases
from coverage5.misc import (
    CoverageException,
    contract,
    file_be_gone,
    filename_suffix,
...
from coverage5.numbits import numbits_to_nums, numbits_union, nums_to_numbits
from coverage5.version import __version__
        ...
        with self._dbs[get_thread_id()] as db:
            try:
                (schema_version,) = db.execute_one(
                    "select version from coverage5_schema"
                )
