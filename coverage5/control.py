...
from coverage5.annotate import AnnotateReporter
from coverage5.backward import string_class, iitems
from coverage5.collector import Collector, CTracer
from coverage5.config import read_coverage_config
from coverage5.context import (
    should_start_context_test_function,
    combine_context_switchers,
)
from coverage5.data import CoverageData, combine_parallel_data
from coverage5.debug import DebugControl, short_stack, write_formatted_info
from coverage5.disposition import disposition_debug_msg
from coverage5.files import (
    PathAliases,
    abs_file,
    relative_filename,
    set_relative_directory,
)
from coverage5.html import HtmlReporter
from coverage5.inorout import InOrOut
from coverage5.jsonreport import JsonReporter
from coverage5.misc import CoverageException, bool_or_none, join_regex
from coverage5.misc import DefaultValue, ensure_dir_for_file, isolate_module
from coverage5.plugin import FileReporter
from coverage5.plugin_support import Plugins
from coverage5.python import PythonFileReporter
from coverage5.report import render_report
from coverage5.results import Analysis, Numbers
from coverage5.summary import SummaryReporter
from coverage5.xmlreport import XmlReporter

try:
    from coverage5.multiproc import patch_multiprocessing
...
class Coverage(object):
    ...
    To use::
        ...
        from coverage5 import Coverage
...
if int(os.environ.get("COVERAGE_DEBUG_CALLS", 0)):  # pragma: debugging
    from coverage5.debug import decorate_methods, show_calls
...
def process_startup():
    ...
    #. Create a .pth file in your Python installation containing::
        ...
        import coverage5 as coverage; coverage.process_startup()
    ...
    if hasattr(process_startup, "coverage5"):
        # We've annotated this function before, so we must have already
        # started coverage.py in this process.  Nothing to do.
        return None

    cov = Coverage(config_file=cps)
    process_startup.coverage5 = cov
...
def _prevent_sub_process_measurement():
    ...
    auto_created_coverage = getattr(process_startup, "coverage5", None)
