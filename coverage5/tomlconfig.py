...
from coverage5.backward import configparser, path_types
from coverage5.misc import CoverageException, substitute_variables
...
class TomlConfigParser:
    ...
    def read(self, filenames):
        from coverage5.optional import toml
