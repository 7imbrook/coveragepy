...
from coverage5.backward import iitems, SimpleNamespace, format_local_datetime
from coverage5.data import add_data_to_hash
...
from coverage5.results import Numbers
from coverage5.templite import Templite
