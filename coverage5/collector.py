...
from coverage5.backward import litems, range  # pylint: disable=redefined-builtin
from coverage5.debug import short_stack
from coverage5.disposition import FileDisposition
from coverage5.misc import CoverageException, isolate_module
...
try:
    ...
    from coverage5.tracer import CTracer, CFileDisposition
except ImportError:
...
class Collector(object):
    ...
    def disable_plugin(self, disposition):
        ...
        self.warn(
            "Disabling plug-in {!r} due to previous exception".format(plugin_name)
        )
