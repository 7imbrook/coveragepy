...
from coverage5.collector import CTracer
from coverage5.data import line_counts
from coverage5.debug import info_formatter, info_header, short_stack
from coverage5.execfile import PyRunner
...
from coverage5.results import should_fail_under
...
if _profile:  # pragma: debugging
    ...
    def main(argv=None):  # pylint: disable=function-redefined
        ...
        try:
            ...
            data, _ = profiler.query(re_filter="coverage5", max_records=100)
