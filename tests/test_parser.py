...
from coverage5.misc import NotPython
...
class PythonParserTest(CoverageTest):
    ...
    def test_exit_counts(self):
        ...
        self.assertEqual(
            parser.exit_counts(), {2: 1, 3: 1, 4: 2, 5: 1, 7: 1, 9: 1, 10: 1}
        )
    ...
    def test_try_except(self):
        ...
        self.assertEqual(
            parser.exit_counts(), {1: 1, 2: 1, 3: 2, 4: 1, 5: 2, 6: 1, 7: 1, 8: 1, 9: 1}
        )
    ...
    def test_excluded_classes(self):
        ...
        self.assertEqual(parser.exit_counts(), {1: 0, 2: 1, 3: 1})
...
class ParserFileTest(CoverageTest):
    ...
    def test_line_endings(self):
        ...
        for fname, newline in name_endings:
            ...
            self.assertEqual(parser.exit_counts(), counts, "Wrong for %r" % fname)
