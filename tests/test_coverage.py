...
class Py25Test(CoverageTest):
    ...
    def test_try_except_finally(self):
        ...
        self.check_coverage(
            ...
            "6",
            arcz=".1 12 23 34 45 56 57 78 6A 8A AB B.",
            arcz_missing="56 6A",
        )
        self.check_coverage(
            """\
