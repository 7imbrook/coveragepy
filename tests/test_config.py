...
class ConfigTest(CoverageTest):
    ...
    def test_toml_config_file(self):
        ...
        self.assertEqual(
            cov.config.get_plugin_options("plugins.a_plugin"), {u"hello": u"world"}
        )
    ...
    def test_tilde_in_config(self):
        ...
        self.assertEqual(
            cov.config.paths, {"mapping": ["/Users/me/src", "/Users/joe/source"]}
        )
    ...
    def test_tweak_plugin_options(self):
        ...
        with self.assertRaisesRegex(
            CoverageException, "No such option: 'no_such.plugin:foo'"
        ):
    ...
    def test_note_is_obsolete(self):
        ...
        with self.assert_warnings(
            cov, [r"The '\[run] note' setting is no longer supported."]
        ):
...
class ConfigFileTest(UsingModulesMixin, CoverageTest):
    ...
    def assert_config_settings_are_correct(self, cov):
        ...
        self.assertEqual(
            cov.config.report_omit, ["one", "another", "some_more", "yet_more"]
        )
